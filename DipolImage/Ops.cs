...
namespace DipolImage
{
    internal static class Ops
    {
        ...
        public static int Max(int x, int y) => (int) (x ^ ((x ^ y) & (((long) x - y) >> (sizeof(long) * ByteSize - 1))));
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint Max(uint x, uint y) => (uint)(x ^ ((x ^ y) & (((long)x - y) >> (sizeof(long) * ByteSize - 1))));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static short Max(short x, short y) => (short)(x ^ ((x ^ y) & ((x - y) >> (sizeof(int) * ByteSize - 1))));
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ushort Max(ushort x, ushort y) => (ushort)(x ^ ((x ^ y) & ((x - y) >> (sizeof(int) * ByteSize - 1))));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int Min(int x, int y) => (int)(y ^ ((x ^ y) & (((long)x - y) >> (sizeof(long) * ByteSize - 1))));
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint Min(uint x, uint y) => (uint)(y ^ ((x ^ y) & (((long)x - y) >> (sizeof(long) * ByteSize - 1))));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static short Min(short x, short y) => (short)(y ^ ((x ^ y) & ((x - y) >> (sizeof(int) * ByteSize - 1))));
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ushort Min(ushort x, ushort y) => (ushort)(y ^ ((x ^ y) & ((x - y) >> (sizeof(int) * ByteSize - 1))));
